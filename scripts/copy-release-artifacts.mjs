...
const readme = [
  ...
  'Dictation runtime, models and recordings live in %APPDATA%\\Music Island\\dictation\\.',
  'Deleting this EXE does not remove AppData. Manage stored files in Settings > System > Data.',
  'This build is unsigned. SHA256.txt verifies integrity, not publisher identity.',
  '',
